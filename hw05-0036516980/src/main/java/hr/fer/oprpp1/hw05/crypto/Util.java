...
/**
 * Klasa nudi statičke metode koje se koriste za prebacivanje zapisa u heksadekadskom obliku u polje bajtova i obrnuto
 * @author vedran
 *
 */
public class Util {
	 ...
	 * @throws IllegalArgumentException ako je duljina neparna ili su nedozvoljeni znakovi u Stringu
	 */
	...
	/**
	 * Metoda ispituje jesu li u ulaznom Stringu samo dozvoljeni znakovi(0...9 i a...f)
