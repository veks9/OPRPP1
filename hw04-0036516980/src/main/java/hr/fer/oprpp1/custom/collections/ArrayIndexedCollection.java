...
public class ArrayIndexedCollection<T> implements List<T> {
	...
	private static class ArrayElementsGetter<T> implements ElementsGetter<T> {
		private int index;
		ArrayIndexedCollection<T> col;
		private long savedModificationCount;

		@SuppressWarnings("unchecked")
		public ArrayElementsGetter(ArrayIndexedCollection<? extends T> arrayCol, long count) {
			col = (ArrayIndexedCollection<T>) arrayCol;
	...
	/**
	 * Vraća kapacitet kolekcije
	 * 
	 * @return kapacitet kolekcije
	 */
