...
//		if(workerTracks[1] < 1) {
//			throw new IllegalArgumentException("Number of tracks has to be greater then 1!");
//		}
		System.out.println(workerTracks[0] +" "+workerTracks[1]);
		ComplexRootedPolynomial rootedPolynomial = new ComplexRootedPolynomial(Complex.ONE, arr);

		FractalViewer.show(new IFractalProducerParallelImpl(rootedPolynomial, workerTracks[0], workerTracks[1]));
